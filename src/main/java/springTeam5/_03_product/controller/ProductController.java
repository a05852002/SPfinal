...
//	搜全部
	...
	public String processSearchAllAction(Model mProd) {
		...
		return "_03_product/shopHome";
	}
//	新版搜全部
	@GetMapping("/_03_product.searchAllProduct2.controller")
	public String processSearchAllAction2(Model mProd) {
		List<Product> result;
		try {
			result = pService.searchAllProduct();
			mProd.addAttribute("allprodlist", result);
		...
		return "_03_product/productMenu";
	}
...
//	跳轉到商品明細
	...
	public String processPathToProductDetail(@RequestParam("id") Integer id, Model mProd, Model mComm)
			throws SQLException {
...
//	新增商品評論
	...
	public String processInsertProdCommentAction(@RequestParam("id") Integer prodID, @RequestParam("comm") String comment,
			@RequestParam("score") Integer score, Model pId) {
		try {
